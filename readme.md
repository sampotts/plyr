...
```html
<script src="https://cdn.plyr.io/3.0.0-beta.6/plyr.js"></script>
```
...
```html
<link rel="stylesheet" href="https://cdn.plyr.io/3.0.0-beta.6/plyr.css">
```

### SVG Sprite

The SVG sprite is loaded automatically from our CDN (provided by [Fastly](https://www.fastly.com/)). To change this, see the [options](#options) below. For
reference, the CDN hosted SVG sprite can be found at `https://cdn.plyr.io/3.0.0-beta.6/plyr.svg`.
