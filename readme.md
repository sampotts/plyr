...
| `customQualitySelector`           | Function                      | `null`                                                                                     | If a function is passed then when the user selects a quality level the passed function will run instead of the default quality management function. This allows you to change HLS/DASH quality levels manually without building custom controls.                                                                                                                                                                                                                                                                                                   |
