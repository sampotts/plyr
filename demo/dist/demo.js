typeof navigator === "object" && (function (Sentry, Shr) {
  ...
  */
  ...
  function setAspectRatio(input) {
    ...
    wrapper.style.paddingBottom = `${padding - 0.25}%`; // For Vimeo we have an extra <div> to hide the standard controls and UI
  ...
  const captions = {
    ...
    update() {
      ...
      toggleClass$1(this.elements.container, this.config.classNames.captions.enabled, !is.empty(tracks)); // Update available languages in list
