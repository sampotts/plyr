        ...
        create: function create(data) {
            ...
            if (this.config.controls.includes('settings') && !is.empty(this.config.settings)) {
                ...
                this.config.settings.forEach(function (type) {
                    ...
                    var button = createElement('button', extend(getAttributesFromSelector(_this8.config.selectors.buttons.settings), {
                        type: 'button',
                    ...
                    _this8.elements.settings.tabs[type] = tab;
                });
                ...
                this.config.settings.forEach(function (type) {
                    ...
                    _this8.elements.settings.panes[type] = pane;
                });
